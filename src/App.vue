...
<template>
  <h1 id="title">Test de Graphique avec Echart.js</h1><br>
  <input id="input1" type="date" v-model="date" /><br>
  <input id="input2" type="number" min="0" max="60" placeholder="Entrer une valeur de température" v-model="valeur" /><br>
